<%-- 
    Document   : Videojuegos_Insertar
    Created on : 17/05/2020, 12:53:56 AM
    Author     : juan_
--%>
...
<html>
    ...
    <center >
        ...
        <form  action = "Productos_InsertarNormal" method="POST">
            <table>
        ...
        <br><br>
        <button onclick="location.href='Productos_opcionesNormal.jsp'">Regresar al inicio</button>
    </center>
    </body>
</html>
