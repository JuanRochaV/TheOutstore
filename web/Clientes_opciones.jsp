...
<html>
    ...
    <center>
        ...
        <button onclick="location.href='Clientes_Insertar.jsp'">Insertar</button>
        <button onclick="location.href='Clientes_Actualizar.jsp'">Actualizar</button>
        <button onclick="location.href='Clientes_Eliminar.jsp'">Eliminar</button>
        <button onclick="location.href='Clientes_Buscar.jsp'">Buscar</button> <br>
