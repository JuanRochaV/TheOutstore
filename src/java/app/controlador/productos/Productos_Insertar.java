 ...
 * @author juan_
 */
@WebServlet (name = "Productos_Insertar", urlPatterns = {"/Productos_Insertar"})
public class Productos_Insertar extends HttpServlet {
...
//        a.setClave(clave);
        ...
        try{
            ...
            if(i == 0){
                paginaRespuesta = "Productos_Insertar.jsp";
