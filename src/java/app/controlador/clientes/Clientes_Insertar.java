 ...
 * @author juan_
 */
@WebServlet (name = "Clientes_Insertar", urlPatterns = {"/Clientes_Insertar"})
public class Clientes_Insertar extends HttpServlet {
...
//        a.setClave(clave);
        ...
        try{
            ...
            if(i == 0){
                paginaRespuesta = "Clientes_Insertar.jsp";
