 ...
 * @author juan_
 */
@WebServlet (name = "Clientes_Actualizar", urlPatterns = {"/Clientes_Actualizar"})
public class Clientes_Actualizar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(i == 0){
                paginaRespuesta = "Clientes_Actualizar.jsp";
