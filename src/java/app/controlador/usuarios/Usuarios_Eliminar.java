 ...
 * @author juan_
 */
@WebServlet (name = "Usuarios_Eliminar", urlPatterns = {"/Usuarios_Eliminar"})
public class Usuarios_Eliminar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(i == 0){
                paginaRespuesta = "Usuarios_Eliminar.jsp";
