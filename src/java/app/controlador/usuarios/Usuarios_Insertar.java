 ...
 * @author juan_
 */
@WebServlet (name = "Usuarios_Insertar", urlPatterns = {"/Usuarios_Insertar"})
public class Usuarios_Insertar extends HttpServlet {
...
//        a.setClave(clave);
        ...
        try{
            ...
            if(i == 0){
                paginaRespuesta = "Usuarios_Insertar.jsp";
