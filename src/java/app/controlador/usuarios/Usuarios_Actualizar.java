 ...
 * @author juan_
 */
@WebServlet (name = "Usuarios_Actualizar", urlPatterns = {"/Usuarios_Actualizar"})
public class Usuarios_Actualizar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(i == 0){
                paginaRespuesta = "Usuarios_Actualizar.jsp";
