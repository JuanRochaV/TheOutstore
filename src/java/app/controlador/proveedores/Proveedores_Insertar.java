 ...
 * @author juan_
 */
@WebServlet (name = "Proveedores_Insertar", urlPatterns = {"/Proveedores_Insertar"})
public class Proveedores_Insertar extends HttpServlet {
...
//        a.setClave(clave);
        ...
        try{
            ...
            if(i == 0){
                paginaRespuesta = "Proveedores_Insertar.jsp";
