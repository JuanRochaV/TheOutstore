 ...
 * @author juan_
 */
@WebServlet (name = "Proveedores_Eliminar", urlPatterns = {"/Proveedores_Eliminar"})
public class Proveedores_Eliminar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(i == 0){
                paginaRespuesta = "Proveedores_Eliminar.jsp";
