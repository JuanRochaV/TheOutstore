 ...
 * @author juan_
 */
@WebServlet (name = "Proveedores_Buscar", urlPatterns = {"/Proveedores_Buscar"})
public class Proveedores_Buscar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(a == null){
                paginaRespuesta = "Proveedores_Buscar.jsp";
                ...
                request.setAttribute("direccion", a.getDireccion());
                request.setAttribute("email", a.getEmail());
                request.setAttribute("paginaWeb", a.getPaginaWeb());
            }
